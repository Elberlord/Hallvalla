...
const CODE_TRUTH_EFFECTS_7HAI={
  ...
  inland_taipan:{trigger:["Debe hacer daño real a HP."],does:["Aplica Veneno 1/2/4 durante 3 ciclos tácticos.","Si una unidad normal ya estaba envenenada y recibe Veneno otra vez, muere.","El líder puede envenenarse, pero no muere automáticamente por doble mordida de la misma unidad."],doesNot:["Si no hiere HP, no envenena."],example:"Es letal contra unidades ya marcadas por veneno."},
