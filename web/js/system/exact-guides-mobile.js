...
const CODE_TRUTH_EFFECTS_7HAI={
  ...
  mulan:{trigger:["Ataque por la espalda: ataca desde una de las tres casillas inmediatamente detrás del objetivo, hacia el lado del líder rival. Los costados no cuentan."],does:["Obtiene +6 AT durante ese combate.","Si destruye una unidad con su ataque normal, intenta reposicionarse automáticamente hasta 1 casilla.","Si después tiene un objetivo válido en alcance, realiza un ataque adicional. Si no, adopta Guardia defensiva (+2 GD ante el primer ataque recibido)."],doesNot:["No gana +6 AT si no cumple la condición de posición.","El ataque adicional no puede volver a activar la misma ejecución.","Todos los ataques siguen las reglas normales de combate."],example:"La ejecución encadena reposición y seguimiento sin controles manuales."},
