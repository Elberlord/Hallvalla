...
const CODE_TRUTH_EFFECTS_7HAI={
  ...
  mulan:{trigger:["Golpe de Apertura: el primer ataque que Hua Lan declara después de entrar al campo recibe +6 AT."],does:["El +6 AT se aplica únicamente a ese primer ataque.","Si destruye una unidad con su ataque normal, intenta reposicionarse automáticamente hasta 1 casilla.","Si después tiene un objetivo válido en alcance, realiza un ataque adicional. Si no, adopta Guardia defensiva (+2 GD ante el primer ataque recibido)."],doesNot:["El +6 AT no vuelve a activarse en ataques posteriores mientras esa Hua Lan permanezca en campo.","El ataque adicional no puede volver a activar la misma ejecución.","Todos los ataques siguen las reglas normales de combate."],example:"Hua Lan abre con un golpe potenciado y, si consigue una baja, puede encadenar reposición y seguimiento automático."},
  ...
  khalid_ibn_al_walid:{trigger:["Cuando destruye una unidad enemiga con un ataque."],does:["Puede encadenar inmediatamente otro ataque si conserva un objetivo válido.","Cada ataque adicional acumula -2 AT; la penalización se limpia en la siguiente restauración periódica de combate."],doesNot:["La cadena termina cuando un ataque adicional no consigue una nueva baja o no existe un objetivo válido.","Cada ataque encadenado sigue las reglas normales de combate."],example:"Cadena automática de bajas con penalización creciente."},
