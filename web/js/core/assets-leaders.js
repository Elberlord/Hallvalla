...
const LEADER_LEVEL_TABLE={
  ...
  10:{hp:38,atk:6,buffTier:4},
  11:{hp:40,atk:7,buffTier:4},
  12:{hp:42,atk:7,buffTier:4},
  13:{hp:44,atk:8,buffTier:4},
  14:{hp:46,atk:8,buffTier:4},
  15:{hp:48,atk:9,buffTier:5}
};
...
const LEADER_LEVEL5_ABILITY_POOL=[
  ...
  {key:"arrow_rain",name:"Lluvia de flechas",short:"Cada 10 s: 1 daño directo a enemigos en RG 3",desc:"Con el Arquero, cada 10 s Lluvia de flechas se activa automáticamente si existe al menos una unidad enemiga a rango 3 o menos. Inflige 1 daño directo a todas las unidades enemigas a rango 3 o menos, ignorando Guardia y stats, y también afecta unidades con Sigilo."},
  {key:"arcane_bolt",name:"Descarga arcana",short:"Cada 10 s: 2 daño directo al líder enemigo",desc:"Con el Hechicero, cada 10 s Descarga arcana se activa automáticamente e inflige 2 de daño directo al líder enemigo, ignorando Guardia y stats de combate."},
  ...
  {key:"cavalry_call",name:"Llamado de la carga",short:"Cada 10 s: convoca hasta 3 Caballerías Ligeras",desc:"Con el Señor de la Carga, cada 10 s Llamado de la carga se activa automáticamente siempre que exista al menos una casilla libre adyacente al líder y convoca hasta tres Caballerías Ligeras aliadas en los espacios disponibles."},
  ...
  {key:"prepare_hunt",name:"Veneno de la Manada",short:"Aliados causan Veneno; dura +20 s",desc:"Con el Señor de las Bestias, todas las unidades aliadas causan Veneno cuando hacen daño real a HP. Ese Veneno dura 20 s más que su duración normal y se duplica cada tick mientras dure."}
];
