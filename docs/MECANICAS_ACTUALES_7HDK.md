# Mecánicas actuales de HallValla · 7HDK

## Resumen del estado actual

- Build base antes de limpieza: `v8_LOCAL_RARITY_REAL_BOARD_7HDI`.
- Build nuevo: `v8_LOCAL_RARITY_REAL_BOARD_7HDK`.
- Tope de recurso: 10.
...
Si ambos jugadores no tienen unidades no-líder y tampoco cartas jugables, gana quien tenga más Vida en su líder. Si la Vida es igual, hay empate.
