...
import {firebaseConfig as hallvallaFirebaseConfig} from "../firebase-config.js?v=7BOARDCTRL8CM-CLEAN1";

const BUILD = "7BOARDCTRL8CM";
const CACHE_BUILD = "7BOARDCTRL8CM-CLEAN1";
