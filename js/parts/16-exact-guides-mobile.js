...
const CODE_TRUTH_EFFECTS_7HAI={
  ...
  new_kingdom_archer:{trigger:["Ataca a distancia sin haberse movido durante ese turno."],does:["El objetivo combate con -2 Guardia durante ese ataque."],doesNot:["Si se movió antes de atacar, no obtiene la reducción de Guardia."],example:"Mantener una posición preparada permite perforar mejor la defensa."},
  ...
  armored_man_at_arms:{trigger:["La primera vez durante cada turno que fuera a perder Vida."],does:["Reduce ese daño en 1."],doesNot:["Solo se activa una vez por turno, aunque reciba varios impactos."],example:"Un golpe que causaría 3 de daño a Vida causa 2 la primera vez de ese turno."},
