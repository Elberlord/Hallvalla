...
function getUnitStatusEntries(u){
  ...
  if(u.leader&&u.leaderType==="archer"&&u.leaderAbility==="arrow_rain")add(`Auto · fin rival`,`Lluvia de flechas`,`Habilidad Nv.5 automática: al final del turno rival, si hay unidades enemigas a rango 4 o menos, inflige 1 daño directo a todas las que estén dentro de rango 4, ignorando Guardia y stats. También afecta Sigilo.`,"buff dex-buff","buff");
