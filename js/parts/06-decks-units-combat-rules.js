...
const ADVENTURE_GUARDIAN_BATTLE={id:"guardian_mage",num:0,isGuardian:true,title:"El guardián hechicero",enemyName:"Hechicero guardián",enemyLeaderType:"mage",image:"assets/story/guardian_intro_bg.webp",actorImage:"assets/story/guardian_hechicero_actor.webp",enemyIntro:"Tras una disputa con la Corona, acabaste convertido en un mercenario al que el propio reino aprendió a despreciar. Podías haber dejado que sus muros ardieran. Pero cuando fuerzas extranjeras cruzaron la frontera con la intención de destruir HallValla y usurpar el trono, regresaste. No por la Corona, sino por una deuda más antigua: esta es la tierra donde nació tu madre, y no permitirás que un invasor la reclame como suya.\n\nAl llegar a la batalla, una figura se interpone entre las ruinas del umbral. Es un mago guardián, cubierto por energía oscura y rodeado por símbolos antiguos.\n\nEl guardián conoce tu pasado y no te reconoce como aliado. Antes de permitirte cruzar hacia la campaña, te obliga a demostrar de qué lado estás. Su derrota abrirá el mapa 1.1, la Forja de mazos y tu primer espacio de Personaje Principal.",xp:20,gold:10,cardPack:true,rewardPackType:"shop_basic",rewardCard:"starter_complement",enemyFixedDeck:[["arcane_adept",3],["spearman",1],["guardian",1],["samurai_katana",1],["saboteador_iga",1],["mongol_explorer",1],["fireball",3],["bolt",3],["shield_wall",2],["heal",1],["inspiration",1],["stabilizing_focus",1],["channeling_amulet",1]],aiLevel:1,aiDrawBonus:0,aiHonorBonus:0,aiStyle:"Tutorial mágico",desc:"Derrota al Hechicero guardián para desbloquear el mapa 1.1, la edición de mazos, el primer Personaje Principal y recibir un Pack básico."};
