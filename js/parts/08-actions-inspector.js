...
function getCardPlayState(card){
  ...
  if(isPvpStep6fLimitedMode()&&card.type!=="unit")return{canPlay:false,reason:"Paso 6G: por ahora solo están habilitadas las cartas de UNIDAD. Hechizos, equipos y trampas siguen bloqueados."};
