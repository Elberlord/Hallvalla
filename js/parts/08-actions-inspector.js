...
function syncHandAutoClose(){
  ...
  if(typeof isHallvallaRealtimeExperimental==="function"&&isHallvallaRealtimeExperimental()){handOpen=true;handManualCloseKey="";return;}
...
function closeHandForBoardFocus(){
  if(typeof isHallvallaRealtimeExperimental==="function"&&isHallvallaRealtimeExperimental()){handOpen=true;const drawer=$("handDrawer");if(drawer)drawer.classList.add("open");return;}
  handOpen=false;
