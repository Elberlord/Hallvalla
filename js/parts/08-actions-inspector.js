...
function isUnitActionWindow(u){if(isPvpStep6fLimitedMode())return false;return !!(u&&isMyTurn()&&u.owner===myPlayer&&isActionPhase())}
...
function getCardPlayState(card){
  ...
  if(isPvpStep6fLimitedMode()&&card.type!=="unit")return{canPlay:false,reason:"Paso 6F: por ahora solo están habilitadas las cartas de UNIDAD. Hechizos, equipos y trampas siguen bloqueados."};
