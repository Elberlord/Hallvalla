...
const SOLOMON_SUMMON_TEMPLATES=Object.freeze({
  solomon_jinn:{key:"solomon_jinn",name:"Gran Jinn de la Fortaleza",type:"unit",icon:"🔷",portrait:"assets/field_figures/special/solomon_jinn.webp",fieldFigure:"assets/field_figures/special/solomon_jinn.webp",rarity:"Mítica",special:true,cost:0,hp:14,atk:9,guard:10,dex:7,agi:4,mov:2,range:1,battlePower:82,solomonSummon:true,text:"Reino Inamovible: Salomón y los aliados adyacentes al Jinn obtienen +3 Guardia. Las unidades protegidas por esta aura no pueden ser empujadas ni desplazadas por efectos enemigos."},
  solomon_ifrit:{key:"solomon_ifrit",name:"Gran Ifrit del Castigo",type:"unit",icon:"🔥",portrait:"assets/field_figures/special/solomon_ifrit.webp",fieldFigure:"assets/field_figures/special/solomon_ifrit.webp",rarity:"Mítica",special:true,cost:0,hp:12,atk:14,guard:7,dex:9,agi:7,mov:2,range:2,battlePower:83,solomonSummon:true,text:"Fuego del Mandato: ignora 4 Guardia. Al causar daño real aplica Quemadura 2 y causa 4 daño directo a enemigos adyacentes al objetivo. Si destruye una unidad, recupera 2 Vida. Inmune a Quemadura."},
  solomon_demon:{key:"solomon_demon",name:"Demonio de los Nombres Encadenados",type:"unit",icon:"⛓️",portrait:"assets/field_figures/special/solomon_demon.webp",fieldFigure:"assets/field_figures/special/solomon_demon.webp",rarity:"Mítica",special:true,cost:0,hp:10,atk:8,guard:6,dex:10,agi:7,mov:2,range:3,battlePower:83,solomonSummon:true,text:"Nombre Verdadero: al manifestarse sella automáticamente a la unidad enemiga de mayor Poder de batalla; esa unidad pierde 3 Destreza y 2 Agilidad mientras el Demonio permanezca manifestado."}
});
