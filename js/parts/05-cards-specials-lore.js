...
function applyDesertAssassinRule(card){
  ...
  card.text="Golpe Final (Asesino): puede atacar a una unidad enemiga con 1 o 2 de Vida si está a 3 casillas o menos; ese ataque ignora Guardia, pero PREC y EVA se resuelven normalmente. Sangrado: cuando logra hacer daño real a HP, el objetivo queda con Sangrado y pierde 1 Vida al inicio de su turno. El Sangrado permanece hasta que la unidad sea curada o destruida. El daño de Sangrado ignora Guardia. Si su dueño tiene Maestro de Sombras Nv.5 con Niebla de sangre, sus demás ataques también ignoran Guardia.";
