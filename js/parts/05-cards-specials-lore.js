...
const HALLVALLA_MINE_UNDEAD_CARDS=Object.freeze([
  {key:"vorthalix_oraculo_osario",assetKey:"vorthalix_oraculo_osario",assetBucket:"special",name:"Vorthalix, Oráculo del Osario",type:"unit",icon:"💀",portrait:CARD_PORTRAITS.vorthalixOraculoOsario,fieldFigure:"assets/field_figures_light/no_muertos/vorthalix_oraculo_osario.webp",rarity:"Legendaria",cost:3,hp:5,atk:3,guard:7,dex:7,agi:3,mov:1,fixedMov:1,range:3,leaderBuffGroups:["mage"],caster:true,nigromante:true,undead:true,noMuerto:true,mineExclusive:true,minePuzzle:true,puzzlePieces:25,puzzlePieceCostGems:250,packEligible:false,craftable:false,randomPoolEligible:false,aiPoolEligible:false,text:"No Muerto — Inmune a Veneno y Sangrado. Restos Persistentes: al morir revive tras 3 turnos de su propietario con 50% de Vida; si muere Congelado tarda 5 turnos. Fuego/Quemadura destruye definitivamente sus restos; Hielo sobre los restos añade +2 turnos."},
  {key:"drakor_guardia_sepulcro",assetKey:"drakor_guardia_sepulcro",assetBucket:"special",name:"Drakor, Guardia del Sepulcro",type:"unit",icon:"⚔️",portrait:CARD_PORTRAITS.drakorGuardiaSepulcro,fieldFigure:"assets/field_figures_light/no_muertos/drakor_guardia_sepulcro.webp",rarity:"Legendaria",cost:4,hp:7,atk:4,guard:10,dex:7,agi:2,mov:1,fixedMov:1,range:1,leaderBuffGroups:["warrior"],undead:true,noMuerto:true,mineExclusive:true,minePuzzle:true,puzzlePieces:25,puzzlePieceCostGems:250,packEligible:false,craftable:false,randomPoolEligible:false,aiPoolEligible:false,text:"No Muerto — Inmune a Veneno y Sangrado. Restos Persistentes: al morir revive tras 3 turnos de su propietario con 50% de Vida; si muere Congelado tarda 5 turnos. Fuego/Quemadura destruye definitivamente sus restos; Hielo sobre los restos añade +2 turnos."},
  {key:"gorthak_hacha_tumulo",assetKey:"gorthak_hacha_tumulo",assetBucket:"special",name:"Gorthak, Hacha del Túmulo",type:"unit",icon:"🪓",portrait:CARD_PORTRAITS.gorthakHachaTumulo,fieldFigure:"assets/field_figures_light/no_muertos/gorthak_hacha_tumulo.webp",rarity:"Legendaria",cost:4,hp:8,atk:6,guard:8,dex:6,agi:3,mov:1,fixedMov:1,range:1,leaderBuffGroups:["axe"],undead:true,noMuerto:true,mineExclusive:true,minePuzzle:true,puzzlePieces:25,puzzlePieceCostGems:250,packEligible:false,craftable:false,randomPoolEligible:false,aiPoolEligible:false,text:"No Muerto — Inmune a Veneno y Sangrado. Restos Persistentes: al morir revive tras 3 turnos de su propietario con 50% de Vida; si muere Congelado tarda 5 turnos. Fuego/Quemadura destruye definitivamente sus restos; Hielo sobre los restos añade +2 turnos."},
  {key:"zyrek_sombra_cripta",assetKey:"zyrek_sombra_cripta",assetBucket:"special",name:"Zyrek, Sombra de la Cripta",type:"unit",icon:"🗡️",portrait:CARD_PORTRAITS.zyrekSombraCripta,fieldFigure:"assets/field_figures_light/no_muertos/zyrek_sombra_cripta.webp",rarity:"Legendaria",cost:3,hp:5,atk:4,guard:5,dex:9,agi:8,mov:1,fixedMov:1,range:1,leaderBuffGroups:["assassin"],undead:true,noMuerto:true,mineExclusive:true,minePuzzle:true,puzzlePieces:25,puzzlePieceCostGems:250,packEligible:false,craftable:false,randomPoolEligible:false,aiPoolEligible:false,text:"No Muerto — Inmune a Veneno y Sangrado. Restos Persistentes: al morir revive tras 3 turnos de su propietario con 50% de Vida; si muere Congelado tarda 5 turnos. Fuego/Quemadura destruye definitivamente sus restos; Hielo sobre los restos añade +2 turnos."},
  {key:"morgash_jinete_osario",assetKey:"morgash_jinete_osario",assetBucket:"special",name:"Morgash, Jinete del Osario",type:"unit",icon:"🐎",portrait:CARD_PORTRAITS.morgashJineteOsario,fieldFigure:"assets/field_figures_light/no_muertos/morgash_jinete_osario.webp",rarity:"Legendaria",cost:4,hp:7,atk:5,guard:9,dex:8,agi:7,mov:1,fixedMov:1,range:1,leaderBuffGroups:["cavalry"],undead:true,noMuerto:true,mineExclusive:true,minePuzzle:true,puzzlePieces:25,puzzlePieceCostGems:250,packEligible:false,craftable:false,randomPoolEligible:false,aiPoolEligible:false,text:"No Muerto — Inmune a Veneno y Sangrado. Restos Persistentes: al morir revive tras 3 turnos de su propietario con 50% de Vida; si muere Congelado tarda 5 turnos. Fuego/Quemadura destruye definitivamente sus restos; Hielo sobre los restos añade +2 turnos."},
  {key:"xulthar_ojo_sepulcro",assetKey:"xulthar_ojo_sepulcro",assetBucket:"special",name:"Xulthar, Ojo del Sepulcro",type:"unit",icon:"🏹",portrait:CARD_PORTRAITS.xultharOjoSepulcro,fieldFigure:"assets/field_figures_light/no_muertos/xulthar_ojo_sepulcro.webp",rarity:"Legendaria",cost:3,hp:5,atk:4,guard:4,dex:8,agi:6,mov:1,fixedMov:1,range:3,leaderBuffGroups:["archer"],undead:true,noMuerto:true,mineExclusive:true,minePuzzle:true,puzzlePieces:25,puzzlePieceCostGems:250,packEligible:false,craftable:false,randomPoolEligible:false,aiPoolEligible:false,text:"No Muerto — Inmune a Veneno y Sangrado. Restos Persistentes: al morir revive tras 3 turnos de su propietario con 50% de Vida; si muere Congelado tarda 5 turnos. Fuego/Quemadura destruye definitivamente sus restos; Hielo sobre los restos añade +2 turnos."}
]);
...
const BEAST_CARD_TEMPLATES=[
  ...
  {key:"inland_taipan",name:"Taipán del Interior",type:"unit",icon:"🐍",portrait:CARD_PORTRAITS.inlandTaipan,rarity:"Gloriosa",cost:3,hp:1,atk:1,guard:0,dex:1,agi:13,mov:2,range:1,beast:true,text:"Mordida Letal: si hace daño real, aplica Veneno 1/2/4 durante 3 turnos. Si una unidad normal ya estaba envenenada y recibe Veneno otra vez, muere. El líder sí se envenena, pero no muere automáticamente por doble mordida de la misma unidad."},
...
const SPECIAL_HUMAN_CARD_DATA=[
  ...
  {key:"boudica",name:"Boudica",type:"unit",icon:"🔥",portrait:CARD_PORTRAITS.boudica,cost:3,hp:4,atk:4,guard:4,dex:8,agi:7,mov:1,range:1,rarity:"Gloriosa",special:true,text:"Ira de Iceni: una vez por turno, cuando un aliado es derrotado, Boudica obtiene +2 Ataque permanente mientras siga en campo. Si el aliado derrotado era especial, también obtiene +1 Movimiento permanente."},
  ...
  {key:"subotai",name:"Subotai / Subutai",type:"unit",icon:"🏇",portrait:CARD_PORTRAITS.subotai,cost:3,hp:4,atk:3,guard:5,dex:11,agi:8,mov:2,range:2,rarity:"Mítica",special:true,text:"Marcha de Mil Horizontes: una vez por turno, elige una unidad aliada. Esa unidad puede moverse 2 casillas adicionales este turno. Puede elegir la misma unidad en turnos seguidos."},
  ...
  {key:"sun_tzu",name:"Sun Tzu",type:"unit",icon:"📜",portrait:CARD_PORTRAITS.sunTzu,cost:3,hp:3,atk:2,guard:1,dex:10,agi:5,mov:1,range:1,rarity:"Mítica",special:true,text:"Arte de la Guerra: una vez por turno, elige un aliado. Ese aliado obtiene +4 Destreza y +4 Guardia hasta el final de su próximo turno."},
...
function applyElementToUndeadRemains(remains=[],x,y,element,{enemyOwner=0}={}){
  ...
  for(const raw of Array.isArray(remains)?remains:[]){
    ...
    if(kind==="ice"){
      ...
      changed=true;affected++;logs.push(`CONGELADO: los restos de ${r.name} retrasan su reanimación +2 turnos (REANIMACIÓN: ${r.turnsRemaining}).`);
    }
    next.push(r);
  }
