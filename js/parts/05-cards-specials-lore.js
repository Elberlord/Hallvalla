...
const SPECIAL_HUMAN_CARD_DATA=[
  ...
  {key:"hannibal_barca",name:"Hannibal Barca",type:"unit",icon:"🐘",portrait:CARD_PORTRAITS.hannibal,cost:4,hp:4,atk:4,guard:8,dex:11,agi:2,mov:3,range:1,rarity:"Mítica",special:true,mountType:"war_elephant",locomotionClass:"mounted_elephant",stompSupport:true,text:"Montura de guerra: Hannibal entra montado en elefante. Trampa de Cannas: una vez por ciclo táctico (10 s), cuando una unidad enemiga queda adyacente a 2 o más unidades aliadas de Hannibal, esa unidad pierde 5 AT y 1 MOV hasta el siguiente ciclo táctico."},
