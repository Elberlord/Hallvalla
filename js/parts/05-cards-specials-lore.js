...
const HALLVALLA_MINE_UNDEAD_CARDS=Object.freeze([
  {key:"vorthalix_oraculo_osario",assetKey:"vorthalix_oraculo_osario",assetBucket:"special",name:"Vorthalix, Oráculo del Osario",type:"unit",icon:"💀",portrait:CARD_PORTRAITS.vorthalixOraculoOsario,fieldFigure:"assets/field_figures_light/no_muertos/vorthalix_oraculo_osario.webp",rarity:"Legendaria",cost:3,hp:3,atk:3,guard:0,dex:6,agi:2,mov:1,range:3,leaderBuffGroups:["mage"],caster:true,nigromante:true,undead:true,noMuerto:true,mineExclusive:true,minePuzzle:true,puzzlePieces:25,puzzlePieceCostGems:250,packEligible:false,craftable:false,randomPoolEligible:false,aiPoolEligible:false,text:"No Muerto — Restos Persistentes: al morir, deja restos óseos en su casilla. Después de 3 turnos de su propietario, revive con 50% de su Vida máxima mientras no sea Exorcizado."},
  {key:"drakor_guardia_sepulcro",assetKey:"drakor_guardia_sepulcro",assetBucket:"special",name:"Drakor, Guardia del Sepulcro",type:"unit",icon:"⚔️",portrait:CARD_PORTRAITS.drakorGuardiaSepulcro,fieldFigure:"assets/field_figures_light/no_muertos/drakor_guardia_sepulcro.webp",rarity:"Legendaria",cost:4,hp:5,atk:4,guard:4,dex:4,agi:2,mov:1,range:1,leaderBuffGroups:["warrior"],undead:true,noMuerto:true,mineExclusive:true,minePuzzle:true,puzzlePieces:25,puzzlePieceCostGems:250,packEligible:false,craftable:false,randomPoolEligible:false,aiPoolEligible:false,text:"No Muerto — Restos Persistentes: al morir, deja restos óseos en su casilla. Después de 3 turnos de su propietario, revive con 50% de su Vida máxima mientras no sea Exorcizado."},
  {key:"gorthak_hacha_tumulo",assetKey:"gorthak_hacha_tumulo",assetBucket:"special",name:"Gorthak, Hacha del Túmulo",type:"unit",icon:"🪓",portrait:CARD_PORTRAITS.gorthakHachaTumulo,fieldFigure:"assets/field_figures_light/no_muertos/gorthak_hacha_tumulo.webp",rarity:"Legendaria",cost:4,hp:6,atk:6,guard:1,dex:4,agi:2,mov:1,range:1,leaderBuffGroups:["axe"],undead:true,noMuerto:true,mineExclusive:true,minePuzzle:true,puzzlePieces:25,puzzlePieceCostGems:250,packEligible:false,craftable:false,randomPoolEligible:false,aiPoolEligible:false,text:"No Muerto — Restos Persistentes: al morir, deja restos óseos en su casilla. Después de 3 turnos de su propietario, revive con 50% de su Vida máxima mientras no sea Exorcizado."},
  {key:"zyrek_sombra_cripta",assetKey:"zyrek_sombra_cripta",assetBucket:"special",name:"Zyrek, Sombra de la Cripta",type:"unit",icon:"🗡️",portrait:CARD_PORTRAITS.zyrekSombraCripta,fieldFigure:"assets/field_figures_light/no_muertos/zyrek_sombra_cripta.webp",rarity:"Legendaria",cost:3,hp:3,atk:4,guard:0,dex:7,agi:6,mov:1,range:1,leaderBuffGroups:["assassin"],undead:true,noMuerto:true,mineExclusive:true,minePuzzle:true,puzzlePieces:25,puzzlePieceCostGems:250,packEligible:false,craftable:false,randomPoolEligible:false,aiPoolEligible:false,text:"No Muerto — Restos Persistentes: al morir, deja restos óseos en su casilla. Después de 3 turnos de su propietario, revive con 50% de su Vida máxima mientras no sea Exorcizado."},
  {key:"morgash_jinete_osario",assetKey:"morgash_jinete_osario",assetBucket:"special",name:"Morgash, Jinete del Osario",type:"unit",icon:"🐎",portrait:CARD_PORTRAITS.morgashJineteOsario,fieldFigure:"assets/field_figures_light/no_muertos/morgash_jinete_osario.webp",rarity:"Legendaria",cost:4,hp:5,atk:5,guard:2,dex:5,agi:4,mov:3,range:1,leaderBuffGroups:["cavalry"],undead:true,noMuerto:true,mineExclusive:true,minePuzzle:true,puzzlePieces:25,puzzlePieceCostGems:250,packEligible:false,craftable:false,randomPoolEligible:false,aiPoolEligible:false,text:"No Muerto — Restos Persistentes: al morir, deja restos óseos en su casilla. Después de 3 turnos de su propietario, revive con 50% de su Vida máxima mientras no sea Exorcizado."},
  {key:"xulthar_ojo_sepulcro",assetKey:"xulthar_ojo_sepulcro",assetBucket:"special",name:"Xulthar, Ojo del Sepulcro",type:"unit",icon:"🏹",portrait:CARD_PORTRAITS.xultharOjoSepulcro,fieldFigure:"assets/field_figures_light/no_muertos/xulthar_ojo_sepulcro.webp",rarity:"Legendaria",cost:3,hp:3,atk:4,guard:1,dex:6,agi:3,mov:1,range:2,leaderBuffGroups:["archer"],undead:true,noMuerto:true,mineExclusive:true,minePuzzle:true,puzzlePieces:25,puzzlePieceCostGems:250,packEligible:false,craftable:false,randomPoolEligible:false,aiPoolEligible:false,text:"No Muerto — Restos Persistentes: al morir, deja restos óseos en su casilla. Después de 3 turnos de su propietario, revive con 50% de su Vida máxima mientras no sea Exorcizado."}
]);
CARD_TEMPLATES.push(...HALLVALLA_MINE_UNDEAD_CARDS.map(card=>({...card})));


const ADVENTURE_SPECIALS={mulan:{key:"mulan",name:"Hua Lan",type:"unit",icon:"🐉",portrait:CARD_PORTRAITS.mulan,fieldFigureAssetBucket:"special",cost:1,hp:3,atk:4,guard:3,dex:4,agi:7,mov:2,range:1,rarity:"Épica",special:true,text:"Ataque por la espalda: cuando Hua Lan ataca desde una de las tres casillas inmediatamente detrás de una unidad enemiga —recta o diagonal, hacia el lado del líder rival— obtiene +6 Ataque durante ese combate. Atacar desde un costado no activa este efecto. El ataque sigue las reglas normales de combate. Si destruye una unidad enemiga durante su ataque normal, puede moverse 1 casilla extra después del combate. Luego debe elegir ATK o DEF; esa elección consume su acción restante y Hua Lan queda sin más acciones este turno."},wallace:{key:"wallace",name:"William Wallace",type:"unit",icon:"🏴",portrait:CARD_PORTRAITS.wallace,fieldFigureAssetBucket:"special",cost:2,hp:5,atk:5,guard:5,dex:6,agi:3,mov:1,range:1,rarity:"Épica",special:true,leaderBuffGroups:["warrior"],text:"Último Aliento: la primera vez que William Wallace recibe daño fatal, sobrevive y queda con 1 Vida."}};
...
const SOLOMON_SUMMON_TEMPLATES=Object.freeze({
  solomon_jinn:{key:"solomon_jinn",name:"Gran Jinn de la Fortaleza",type:"unit",icon:"🔷",portrait:"assets/cards/special/units/solomon_jinn.webp",fieldFigure:"assets/field_figures_light/special/solomon_jinn.webp",rarity:"Mítica",special:true,cost:0,hp:14,atk:9,guard:10,dex:7,agi:4,mov:2,range:1,battlePower:82,solomonSummon:true,text:"Reino Inamovible: Salomón y los aliados adyacentes al Jinn obtienen +3 Guardia. Las unidades protegidas por esta aura no pueden ser empujadas ni desplazadas por efectos enemigos."},
  solomon_ifrit:{key:"solomon_ifrit",name:"Gran Ifrit del Castigo",type:"unit",icon:"🔥",portrait:"assets/cards/special/units/solomon_ifrit.webp",fieldFigure:"assets/field_figures_light/special/solomon_ifrit.webp",rarity:"Mítica",special:true,cost:0,hp:12,atk:14,guard:7,dex:9,agi:7,mov:2,range:2,battlePower:83,solomonSummon:true,text:"Fuego del Mandato: ignora 4 Guardia. Al causar daño real aplica Quemadura 2 y causa 4 daño directo a enemigos adyacentes al objetivo. Si destruye una unidad, recupera 2 Vida. Inmune a Quemadura."},
  solomon_demon:{key:"solomon_demon",name:"Demonio de los Nombres Encadenados",type:"unit",icon:"⛓️",portrait:"assets/cards/special/units/solomon_demon.webp",fieldFigure:"assets/field_figures_light/special/solomon_demon.webp",rarity:"Mítica",special:true,cost:0,hp:10,atk:8,guard:6,dex:10,agi:7,mov:2,range:3,battlePower:83,solomonSummon:true,text:"Nombre Verdadero: al manifestarse sella automáticamente a la unidad enemiga de mayor Poder de batalla; esa unidad pierde 3 Destreza y 2 Agilidad mientras el Demonio permanezca manifestado."}
});
