...
Repository layout prepared for HallValla v137 infrastructure.
...
- Public distribution shell: v137 (menu button/resource containers transparent + smaller Android icon moved to throne crest; no gameplay rebalance)
