...
function renderDetail(){
  ...
  if(selectedCard){
    const cardStats=selectedCard.type==="unit"
      ? [["Costo",selectedCard.cost||0],["AT",selectedCard.atk||0],["HP",selectedCard.hp||0],["GD",selectedCard.guard||0],["DX",selectedCard.dex||0],["AGI",selectedCard.agi||0],["MV",selectedCard.mov||0],["RG",getCardDisplayRange(selectedCard)]]
